...
class SwinIR(nn.Module):
    ...
    Args:
        ...
        upsampler: The reconstruction module. 'pixelshuffle'/'pixelshuffledirect'/
            'nearest+conv'/'bilinear+conv-residual'/None
    ...
    def __init__(self, img_size=64, patch_size=1, in_chans=3,
        ...
        elif self.upsampler in ['nearest+conv', 'bilinear+conv-residual']:
    ...
    def forward(self, x):
        ...
        if self.upsampler == 'pixelshuffle':
        ...
        elif self.upsampler == 'bilinear+conv-residual':
            ...
            x = base + self.conv_last(self.lrelu(self.conv_hr(x)))
        else:
            # for image denoising and JPEG compression artifact reduction
